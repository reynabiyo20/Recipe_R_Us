...
public class AuthenticationFilter extends HandlerInterceptorAdapter {
    ...
    private static final List<String> whitelist = Arrays.asList("/home", "/login", "/register", "/logout", "/css", "/recipes/all", "/recipes/display", "/search" , "/recipes" ,"/recipes/create", "recipes/create-tags");
